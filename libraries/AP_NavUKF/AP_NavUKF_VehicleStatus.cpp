...
*/
void NavUKF_core::calcGpsGoodToAlign(void)
{
...
void NavUKF_core::calcGpsGoodForFlight(void)
{
...
void NavUKF_core::setTerrainHgtStable(bool val)
{
...
void NavUKF_core::detectOptFlowTakeoff(void)
{
